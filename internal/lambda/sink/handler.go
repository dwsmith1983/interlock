// Package sink implements the event-sink Lambda handler.
// It writes EventBridge events to DynamoDB for audit trail.
package sink
...
func HandleEventSink(ctx context.Context, d *lambda.Deps, input lambda.EventBridgeInput) error {
