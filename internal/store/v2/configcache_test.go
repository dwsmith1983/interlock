...
func seedConfig(mock *mockDDB, table string, cfg v2.PipelineConfig) {
...
func TestScanConfigs_MultipleConfigs(t *testing.T) {
	...
	seedConfig(mock, "control", v2.PipelineConfig{
		Pipeline: v2.PipelineIdentity{ID: "pipeline-a", Owner: "team-a"},
	})
	seedConfig(mock, "control", v2.PipelineConfig{
		Pipeline: v2.PipelineIdentity{ID: "pipeline-b", Owner: "team-b"},
	})

	// Also seed a non-CONFIG row to verify filtering.
	mock.putRaw("control", map[string]ddbtypes.AttributeValue{
		"PK": &ddbtypes.AttributeValueMemberS{Value: v2.PipelinePK("pipeline-a")},
		"SK": &ddbtypes.AttributeValueMemberS{Value: v2.SensorSK("upstream")},
...
func TestScanConfigs_MissingConfigAttribute(t *testing.T) {
	...
	mock.putRaw("control", map[string]ddbtypes.AttributeValue{
		"PK": &ddbtypes.AttributeValueMemberS{Value: v2.PipelinePK("broken")},
		"SK": &ddbtypes.AttributeValueMemberS{Value: v2.ConfigSK},
	})
...
func TestConfigCache_GetAll_Fresh(t *testing.T) {
	...
	seedConfig(mock, "control", v2.PipelineConfig{
		Pipeline: v2.PipelineIdentity{ID: "pipe-1", Owner: "team-1"},
	})
	seedConfig(mock, "control", v2.PipelineConfig{
		Pipeline: v2.PipelineIdentity{ID: "pipe-2", Owner: "team-2"},
	})
...
func TestConfigCache_GetAll_Cached(t *testing.T) {
	...
	seedConfig(mock, "control", v2.PipelineConfig{
		Pipeline: v2.PipelineIdentity{ID: "pipe-1"},
	})
...
func TestConfigCache_GetAll_Stale(t *testing.T) {
	...
	seedConfig(mock, "control", v2.PipelineConfig{
		Pipeline: v2.PipelineIdentity{ID: "pipe-2"},
	})
...
func TestConfigCache_Get_SinglePipeline(t *testing.T) {
	...
	seedConfig(mock, "control", v2.PipelineConfig{
		Pipeline: v2.PipelineIdentity{ID: "target", Owner: "found-it"},
	})
	seedConfig(mock, "control", v2.PipelineConfig{
		Pipeline: v2.PipelineIdentity{ID: "other", Owner: "not-this"},
	})
...
func TestConfigCache_Get_NotFound(t *testing.T) {
	...
	seedConfig(mock, "control", v2.PipelineConfig{
		Pipeline: v2.PipelineIdentity{ID: "exists"},
	})
...
func TestConfigCache_ConcurrentAccess(t *testing.T) {
	...
	seedConfig(mock, "control", v2.PipelineConfig{
		Pipeline: v2.PipelineIdentity{ID: "concurrent-pipe"},
	})
	...
	results := make([]map[string]*v2.PipelineConfig, goroutines)
