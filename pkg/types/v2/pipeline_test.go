...
func TestPipelineConfig_UnmarshalYAML(t *testing.T) {
	...
	assert.Equal(t, v2.CheckEquals, cfg.Validation.Rules[0].Check)
	assert.Equal(t, v2.CheckGTE, cfg.Validation.Rules[1].Check)
...
func TestPipelineConfig_StreamTriggered(t *testing.T) {
	...
	assert.Equal(t, v2.CheckEquals, cfg.Schedule.Trigger.Check)
	...
	assert.Len(t, cfg.Validation.Rules, 2)
	assert.Equal(t, v2.CheckExists, cfg.Validation.Rules[1].Check)
...
func TestPipelineConfig_Minimal(t *testing.T) {
	...
	assert.Equal(t, v2.CheckExists, cfg.Validation.Rules[0].Check)
...
func TestPipelineConfig_CalendarSchedule(t *testing.T) {
	...
	assert.Equal(t, v2.CheckEquals, cfg.Validation.Rules[0].Check)
	assert.Equal(t, v2.CheckGT, cfg.Validation.Rules[1].Check)
	assert.Equal(t, v2.CheckAgeLT, cfg.Validation.Rules[2].Check)
